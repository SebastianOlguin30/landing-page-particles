            ...
            <div className="z-20 grid items-center h-full p-6 py-20 md:py-0 md:grid-cols-2">
                ...
                <div className="flex flex-col justify-center max-w-md">
                    ...
                    <p className="mx-auto mb-2 text-xl md:mx-0 md:mb-8">
                        Como Operador DevOps, me dedico a mejorar la eficiencia y confiabilidad de los sistemas, enfocándome en la automatización, la colaboración y la entrega continua para crear soluciones tecnológicas robustas y escalables.
                    </p>
